...
set term qt size 360,260 font 'Times,8'
...
@NOXTICS; @NOYTICS
LABEL='II'
set ytics 20,15,50 scale .5
set obj 1 rect at graph 0.828,0.86 size char strlen(LABEL)+1.2, char 1
set label 1 LABEL at graph 0.795,0.86
set key left
plot '../../../data/simulation3/raw3/energy_simulation3B_resized.csv' using 1:2 w l title 'energy' ls 1 lw .6
