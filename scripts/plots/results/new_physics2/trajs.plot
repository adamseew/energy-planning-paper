...
set lmargin at screen 0.19; set rmargin at screen 0.54
...
set tmargin at screen 0.96; set bmargin at screen 0.70
set lmargin at screen 0.56; set rmargin at screen 0.91
LABEL='II'
unset ylabel
...
unset label
unset obj
set tmargin at screen 0.68; set bmargin at screen 0.53; 
set lmargin at screen 0.66; set rmargin at screen 0.94
set yrange [1:11]
set ytics ('' 2, '' 6, '' 10) mirror scale .2
set format y ''
unset ylabel
set xrange [0:403.01] 
set xtics ('' 0, '' 120, '' 240, '' 360) 
unset xlabel
set y2range [1:11]
...
set tmargin at screen 0.53; set bmargin at screen 0.38; 
set lmargin at screen 0.66; set rmargin at screen 0.94
set yrange [-1100:100]
set ytics ('' 0, '' -500, '' -1000) offset .1,0 mirror scale .2
set xrange [0:403.01] 
set xtics ('' 0, '' 120, '' 240, '' 360) offset 0,.3 scale .2
unset xlabel
unset ylabel
...
set tmargin at screen 0.36; set bmargin at screen 0.21; 
set lmargin at screen 0.66; set rmargin at screen 0.94
set yrange [1:11]
set ytics ('' 2, '' 6, '' 10) mirror scale .2
set format y ''
...
set tmargin at screen 0.21; set bmargin at screen 0.06; 
set lmargin at screen 0.66; set rmargin at screen 0.94
