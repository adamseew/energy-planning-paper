...
\begin{thm}\label{thm:2.2}
  ...
  Assume a mobile robot performs a periodic mission free to move in $\mathcal{P}$ defined in~(\ref{eqq:2}), and likewise Lemma~\ref{lem:2.1}, the model behaves ideally. 
  Then the instantaneous energy is a linear combination of the state
  \begin{equation}
