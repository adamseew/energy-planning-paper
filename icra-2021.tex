...
The observation applies broadly; we show how many UAV scenarios have a repetitive energy evolution. Moreover, we briefly investigate these patterns in some ground-based mobile robots. We use Fourier analysis to derive the model, and state estimation to address the uncertainty. The algorithm outputs the parameters using output model predictive control (MPC).
