...
{ \color{blue}and} the problem formulation. Section~\ref{sec:algo} describes in detail the methodology of planning-scheduling. Section~\ref{sec:experimental} presents the results, %and showcases the performances, 
...
state with current energy sensor reading $\Upsilon$, with, e.g., %linear 
