...
We implemented a realistic simulator to simulate the empirical data of a given plan and atmospheric conditions. We show the effects of different conditions in Figure~\ref{fig:trajs}. Both paths I and II are flying the same plan. Path I is flying with a constant wind speed of 5 meters per second and wind direction of 90 degrees (north). Path II is flying under the same conditions but a wind direction of 0 degrees (east). The energy evolutions of the paths are the top two subfigures of Figure~\ref{fig:ener}.
