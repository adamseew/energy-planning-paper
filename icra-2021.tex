...
The mission is a time-varying motion plan and a set of tasks the UAV is supposed to perform along the TEEs and QoS parameters constraints
...
The algorithm inputs the mission and outputs the correction to the position and the instantaneous energy consumption, while it adapts the control $\mathbf{u}_k$ in function of the TEE and QoS parameters.
