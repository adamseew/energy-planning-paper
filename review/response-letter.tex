...
\begin{formal}\color{black}
  ...
  in-flight. %in an energy-aware way. %{\color{blue}, whereas }
  {\color{blue} 
  The re-planning-scheduling improves a performance metric, which is %quality of the plan and schedule against battery state of charge (SoC), i.e., the 
