...
Suppose at time instant $k$ the plan reached stage $i$ and the control input is $\mathbf{u}_k^a:=\langle\mathbf{c}_k,\mathbf{s}_k\rangle$. The control along with the input matrix
...
The energy consumption modeling of the plan utilizes the following assumption.
