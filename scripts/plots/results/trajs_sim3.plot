...
plot '../../../data/simulation3/raw1/position_simulation3_resized.csv' using 1:2 w l ls 1 lw .6
...
set key left
plot '../../../data/simulation3/raw3/position_simulation3B_resized.csv' using 1:2 w l title 'path' ls 1 lw .6
...
plot '../../../data/simulation3/raw4/position_simulation3C_resized.csv' using 1:2 w l ls 1 lw .6
...
plot '../../../data/simulation3/raw5/position_simulation3D_resized.csv' using 1:2 w l ls 1 lw .6
unset multiplot
