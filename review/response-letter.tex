...
\begin{formal}
  ...
  \color{black}i.e., $h,y$ are both harmonic signals with the same frequencies. {\color{blue}Further details are proposed in the first author's Ph.D. thesis~[{\color{green}31}]}.
  }
  \vspace*{1ex}
\end{formal}
}
...
\color{black}
  ...
  Fig.~1:~The figure shows an initial plan~(in~{\color{red}i}) re-planned online, changing the resolution, detection rate, or other computational aspects~(in~{\color{red}ii}) and changing the number of fly-bys or other motion aspects~(in~{\color{red}sth:iii}). 
