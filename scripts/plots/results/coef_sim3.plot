...
plot '../../../data/simulation3/raw5/updated/coefdata_simulation3D_resized.csv' using 1:3 w l ls 1 lw .6 title 'a1';

set tmargin at screen 0.72; set bmargin at screen 0.60
set lmargin at screen 0.16; set rmargin at screen 0.89
@YTICS
set key at screen 0.86,0.66
plot '../../../data/simulation3/raw5/updated/coefdata_simulation3D_resized.csv' using 1:4 w l ls 1 lw .6 title 'b1';

set tmargin at screen 0.60; set bmargin at screen 0.48
set lmargin at screen 0.16; set rmargin at screen 0.89
@YTICS
set key at screen 0.86,0.54
plot '../../../data/simulation3/raw5/updated/coefdata_simulation3D_resized.csv' using 1:5 w l ls 1 lw .6 title 'a2';

set tmargin at screen 0.48; set bmargin at screen 0.36
set lmargin at screen 0.16; set rmargin at screen 0.89
@YTICS
set key at screen 0.86,0.42
plot '../../../data/simulation3/raw5/updated/coefdata_simulation3D_resized.csv' using 1:6 w l ls 1 lw .6 title 'b2';
...
set key at screen 0.86,0.30
plot '../../../data/simulation3/raw5/updated/coefdata_simulation3D_resized.csv' using 1:7 w l ls 1 lw .6 title 'a3';
...
set key at screen 0.86,0.18
plot '../../../data/simulation3/raw5/updated/coefdata_simulation3D_resized.csv' using 1:7 w l ls 1 lw .6 title 'b3';
