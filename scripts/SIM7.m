...
% control
u = @(c1,c1_old,c2,c2_old) diag([nu1 nu2])*([c1;c2]-[c1_old;c2_old])-...
    [tau1;tau2];
...
while true 
    ...
    while true
            ...
            while or(bat_success < N,...
                ...
                for j=k-1:k+N-2
                    ...
                    if j == k+N-2
                        ...
                        costs(end) = costs(end)+...
                            .5*(qq0+B*u(c1,c1_old,c2,c2_old)).'*diag(C)*...
                            (qq0+B*u(c1,c1_old,c2,c2_old));
                    end
                end
            end
        ...
        q1_minus = Ad*q0+B*u(c1,c1_old,c2,c2_old);
        P1_minus = Ad*P0*Ad.'+Q;
