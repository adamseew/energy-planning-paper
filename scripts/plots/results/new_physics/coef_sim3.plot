...
set term qt size 160,240 font 'Times,8'
...
set xrange [0:200]
set yrange [20:32]
set ytics ('30' 30, '24' 24) right scale .5
...
plot '../../../../data/simulation3/raw5/new_physics/static/energy_simulation3Ds_resized.csv' using 1:4 w l ls 1 lw .6 title 'a0';
...
plot '../../../../data/simulation3/raw5/new_physics/static/energy_simulation3Ds_resized.csv' using 1:5 w l ls 1 lw .6 title 'a1';

set tmargin at screen 0.72; set bmargin at screen 0.60
set lmargin at screen 0.16; set rmargin at screen 0.89
@YTICS
set key at screen 0.86,0.66 samplen .5
plot '../../../../data/simulation3/raw5/new_physics/static/energy_simulation3Ds_resized.csv' using 1:6 w l ls 1 lw .6 title 'b1';

set tmargin at screen 0.60; set bmargin at screen 0.48
set lmargin at screen 0.16; set rmargin at screen 0.89
@YTICS
set key at screen 0.86,0.54 samplen .5
plot '../../../../data/simulation3/raw5/new_physics/static/energy_simulation3Ds_resized.csv' using 1:7 w l ls 1 lw .6 title 'a2';

set tmargin at screen 0.48; set bmargin at screen 0.36
set lmargin at screen 0.16; set rmargin at screen 0.89
@YTICS
set key at screen 0.86,0.42 samplen .5
plot '../../../../data/simulation3/raw5/new_physics/static/energy_simulation3Ds_resized.csv' using 1:8 w l ls 1 lw .6 title 'b2';
...
plot '../../../../data/simulation3/raw5/new_physics/static/energy_simulation3Ds_resized.csv' using 1:9 w l ls 1 lw .6 title 'a3';
...
plot '../../../../data/simulation3/raw5/new_physics/static/energy_simulation3Ds_resized.csv' using 1:10 w l ls 1 lw .6 title 'b3';
