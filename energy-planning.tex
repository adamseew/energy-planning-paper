...
The remaining sections of the letter are then organized as follows. Sec.~\ref{sec:prob} provides basic constructs, such as the concepts of the plan, stages, triggering and final points, and path functions, as well as the problem formulation. Sec.~\ref{sec:algo} describes in detail the methodology of planning-scheduling. Sec.~\ref{sec:experimental} presents the results and showcases the performances, and Sec.~\ref{sec:conclusion} concludes and provides future perspectives. Appendices provide supplementary material.
